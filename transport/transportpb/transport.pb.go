...
func (m *RaftMsg) GetMsg() *raftpb.Message {
	if m != nil {
		return m.Msg
	}
	return nil
...
func (m *RaftMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Msg != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTransport(dAtA, i, uint64(m.Msg.Size()))
...
var fileDescriptorTransport = []byte{
	...
	,
}
